...
{ 
    // pt is plain text 
    string pt, key,pt1,pt2; 
    /*cout<<"Enter plain text(in hexadecimal): "; 
    cin>>pt; 
    cout<<"Enter key(in hexadecimal): "; 
    cin>>key;*/
    pt = "01111000101100000100000001011010000111001100110101000001101010110000010100010101011011100001000111001110000111001110001111001001";

    pt1 = pt.substr(0,64);
    pt2 = pt.substr(64,64);
    key = "1110101100001010010001001111010110000111000010100110111101010000"; 
    // Key Generation 
    ...
    string text = encrypt(pt1, rkb, rk); 
    cout << "\nPlain Text: " << text << endl;
    text = encrypt(pt2, rkb, rk);
    cout << "\nPlain Text: " << text << endl;
