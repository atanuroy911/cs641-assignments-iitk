...
{ 
    ...
    int final_perm[64] = { 8,40,16,48,24,56,32,64,
...
int main() 
{ 
    ifstream keys {"key_out.txt"};
    // pt is plain text 
    string pt, key, out, output; 
    /*cout<<"Enter plain text(in hexadecimal): "; 
    cin>>pt; 
    cout<<"Enter key(in hexadecimal): "; 
    cin>>key;*/
    
    // pt = "1011010010010111101001011010010010011010011010011101110101110100";
    // out = "1110100011011110001111101100111101010011011001110100101110100101";
    pt = "1111000010010110111001001011010110001111011111001101100001110101";
    out = "0001110110011010111110111000010110000100111111110011101011110000";
    for(int i=0;i<256;i++){
        keys >> key;
        output = encrypt(pt,key);
        // cout << output <<"\n";
        if(output == out){
            cout<<key<<"\n";
            break;
