...
def reverse_permute():
	if os.path.isfile('cipher2.txt'):
			f_in = open('cipher2.txt','r')
			f_out = open('finalcipher2.txt','w')
			for line in f_in:
				c1 = line[:64]
				c2 = line[65:-1]
...
def compute_sbox_xor():
	if os.path.isfile('finalcipher2.txt'):
		f_in = open('finalcipher2.txt','r')
		f_out = open('cipherxor2.txt','w')
		f_exp = open('expandr52.txt','w')
		f_sbox_inp = open('inputxor2.txt','w')
		f_sbox_out = open('outputxor2.txt','w')
		for line in f_in:
			c1 = line[:64]
			c2 = line[65:-1]
			c1_l6 = c1[:32]
